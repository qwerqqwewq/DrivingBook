...
public class ListViewAdapter extends BaseAdapter {
    ...
    public
    ListViewAdapter(Context context, int resource, ArrayList<String> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null ) {
            ...
            vh.vv1=convertView.findViewById(R.id.videoView);
            vh.vv2=convertView.findViewById(R.id.videoView2);
